      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <span className="mx-2">/</span>
            <span className="text-green-600 font-medium">Herramientas</span>
          </div>
        </div>

        {/* Category Header */}
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-bold animate-fadeIn">Herramientas</h1>
            ...
            <div className="relative">
              ...
              <div className="h-48 flex items-center justify-center p-4 bg-gray-50">
                <Image
                  ...
                  alt="Kit de Herramientas Básico"
                  width={150}
                  height={150}
          ...
          <Card className="overflow-hidden h-full flex flex-col hover:shadow-lg transition-shadow animate-fadeIn">
            <div className="relative">
              ...
              <div className="h-48 flex items-center justify-center p-4 bg-gray-50">
                <Image
                  src="/images/tools.png"
                  alt="Tijeras de Podar Profesionales"
                  width={150}
                  height={150}
                  className="object-contain h-full transform hover:scale-105 transition-transform"
                />
